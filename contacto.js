...
(email.length < 5) || (email.indexOf("@") == -1) || (email.indexOf(".") == -1) || (nombre.length < 5) || (telefono.length < 7) || (mensaje.length < 10)? errorForm.innerHTML = `<p class="bg-danger col-12 col-md-12 mx-auto text-white parrafo ps-3 py-2 pe-4  p-lg-3 rounded">Revise los campos requeridos!</p>` : errorForm.innerHTML = `<p class="mx-auto bg-purple text-white  ps-3 py-2 pe-4 parrafo p-lg-3 rounded">Gracias por comunicarte con nosotros!</p>`;
}
